...
reload(hr)
#reloding in case you are running this in iPython
...
#page.append("Here is a paragraph of text -- there could be more of them, but this is enough"
...
body.append(hr.P("Here is a paragraph of text -- there could be more of them, but this is enough  to show that we can"
                 " do some text", style="text-align: center; font-style: oblique;"))
